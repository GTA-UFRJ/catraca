...
#    modelPCA = pca.fit(assembledData)
#    result = modelPCA.transform(assembledData) 
...
#    featureIndexer = VectorIndexer(inputCol="pcaFeatures", outputCol="indexedFeatures", maxCategories=20).fit(result)
